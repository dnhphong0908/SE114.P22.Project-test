...
import com.se114p12.backend.service.product.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> createProduct(@Valid @ModelAttribute ProductRequestDTO productRequestDTO) {
        return ResponseEntity.ok(productService.create(productRequestDTO));
    }

    @PutMapping(value = "/{id}")
    public ResponseEntity<Product> updateProduct(@PathVariable("id") Long id, @Valid @ModelAttribute ProductRequestDTO productRequestDTO) {
