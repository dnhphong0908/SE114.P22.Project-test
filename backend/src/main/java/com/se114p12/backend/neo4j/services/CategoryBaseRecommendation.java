...
@Service
public class CategoryBaseRecommendation implements RecommendationStrategy {

  private final ProductNeo4jRepository productRepository;

  @Override
  public List<Long> getRecommendedProductIds(Long userId) {
    return productRepository.findRecommendByCategory(userId);
  }

  @Override
  public Double getScore() {
    return RecommendationSource.CATEGORY_BASED.getScore();
  }
}
